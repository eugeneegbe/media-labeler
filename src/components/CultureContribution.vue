<template>
    <div class="contrib-questions">
        ...
        <div class="input-group mb-3">
            <p class="question">How familiar are you with the cultural background of the food item in the image?</p>
        ...
        <div class="input-group mb-3">
            <p class="question">Do you think the food depicted in the image is accurately represented by the file name or description?</p>
